        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Communications_Users_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinSquareMeter = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    MaxSquareMeter = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    MinCountOfRooms = table.Column<int>(type: "int", nullable: true),
                    MaxCountOfRooms = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_Communications_CommunicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_CommunicationId",
                table: "Addresses",
